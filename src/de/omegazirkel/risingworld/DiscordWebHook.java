...
public class DiscordWebHook extends Plugin implements Listener, FileChangeListener {
	...
	public static OZLogger logger() {
		return OZLogger.getInstance("OZ.DiscordPlugin");
	}

	public static OZLogger eventLogger() {
		return OZLogger.getInstance("OZ.DiscordPlugin.Event");
	}
	...
	// Timer
	static Timer restartTimer = new Timer("OZDiscordPlugin-RestartTimer", true);
	static Timer activityTimer = new Timer("OZDiscordPlugin-ActivityTimer", true);
